...
document.addEventListener('DOMContentLoaded', function (){
    const customEventHeader = document.querySelector('#custom-event-header')
    customEventHeader.innerHTML = `
    <!-- Topbar Start -->
...
document.addEventListener('DOMContentLoaded', function (){
    const customEventFooter = document.querySelector('#custom-event-footer')
    customEventFooter.innerHTML = `
    <!-- Footer Start -->
